        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="terms" className="text-sm text-gray-500">
                ...
                <Link to="/terms" className="text-[#4b2a75] hover:underline">Terms of Use</Link>
                {" "}&{" "}
                <Link to="/privacy" className="text-[#4b2a75] hover:underline">Privacy Policy</Link>
              </label>
            </div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/login" className="text-[#4b2a75] hover:underline font-semibold">
                Sign in
              </Link>
            </p>
          </div>
